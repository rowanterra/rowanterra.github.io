    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-presenting-two-talks-recursive-modeling-connects-geochemistry-and-genomics-in-critical-minerals-characterization-and-microbiological-mining-of-critical-minerals-is-altered-by-community-modifying-metal-enrichments-at-the-geological-society-of-america-connects-2025-conference-in-san-antonio-tx",
          title: 'Presenting two talks: Recursive Modeling Connects Geochemistry and Genomics in Critical Minerals Characterization...',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-gta-perspectives-on-teaching-training",
          title: 'GTA Perspectives on Teaching Training',
          description: "A completed educational research project",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%6F%77%61%6E.%72.%74%65%72%72%61(%61%74)%67%6D%61%69%6C(%64%6F%74)%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/rowanterra", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/rowan-terra", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0001-3890-705X", "_blank");
        },
      },{
        id: 'social-scholar',
